...
func (s *apiTradeTestSuite) TestTestCreateOrder() {
	msg := []byte(`{
...
func (s *apiTradeTestSuite) assertTestCreateTestOrder(r1, r2 *TestCreateOrderResponse) {
	r := s.r()
...
func (s *apiTradeTestSuite) TestNewCancelOrder() {
	msg := []byte(`{
  "symbol": "LTCBTC",
...
func (s *apiTradeTestSuite) assertTestOrderResult(r1, r2 *CancelOpenOrderResponse) {
	r := s.r()
	r.Equal(r1.Symbol, r2.Symbol, "symbol")
...
func (s *apiTradeTestSuite) TestNewCancelReplace() {
	msg := []byte(`{
...
func (s *apiTradeTestSuite) assertTestCancelReplaceOrder(r1, r2 *CancelReplaceResponse) {
	r := s.r()
	if r1.Code != 0 {
...
func (s *apiTradeTestSuite) TestNewAllOpenOrders() {
	msg := []byte(`[
  {
    "symbol": "LTCBTC",
    "orderId": 1,
...
func (s *apiTradeTestSuite) assertTestAllOpenOrders(r1, r2 *OrdersResponse) {
	r := s.r()
	r.Equal(r1.Symbol, r2.Symbol, "symbol")
	r.Equal(r1.OrderId, r2.OrderId, "orderId")
	r.Equal(r1.OrderListId, r2.OrderListId, "orderListId")
...
func (s *apiTradeTestSuite) TestNewAllOrders() {
	msg := []byte(`[
  {
    "symbol": "LTCBTC",
    "orderId": 1,
...
func (s *apiTradeTestSuite) TestNewCancelOrderList() {
	msg := []byte(`{
  "orderListId": 0,
  "contingencyType": "OCO",
  "listStatusType": "ALL_DONE",
...
func (s *apiTradeTestSuite) assertTestOrderListResponse(r1, r2 *OrderListResponse) {
	r := s.r()
	r.Equal(r1.OrderListId, r2.OrderListId, "orderListId")
	r.Equal(r1.ContingencyType, r2.ContingencyType, "contingencyType")
	r.Equal(r1.ListStatusType, r2.ListStatusType, "listStatusType")
...
func (s *apiTradeTestSuite) TestNewQueryOrderList() {
	msg := []byte(`{
  "orderListId": 27,
  "contingencyType": "OCO",
...
func (s *apiTradeTestSuite) assertTestQueryOrderListResponse(r1, r2 *QueryOrderListResponse) {
	r := s.r()
	r.Equal(r1.OrderListId, r2.OrderListId, "orderListId")
	r.Equal(r1.ContingencyType, r2.ContingencyType, "contingencyType")
	r.Equal(r1.ListStatusType, r2.ListStatusType, "listStatusType")
...
func (s *apiTradeTestSuite) TestNewQueryAllOrderLists() {
	msg := []byte(`[
  {
    "orderListId": 29,
    "contingencyType": "OCO",
...
func (s *apiTradeTestSuite) assertTestQueryAllOrderListsResponse(r1, r2 *QueryAllOrderListsResponse) {
	r := s.r()
	r.Equal(r1.OrderListId, r2.OrderListId, "orderListId")
	r.Equal(r1.ContingencyType, r2.ContingencyType, "contingencyType")
	r.Equal(r1.ListStatusType, r2.ListStatusType, "listStatusType")
...
func (s *apiTradeTestSuite) TestNewQueryOpenOrderList() {
	msg := []byte(`[
  {
    "orderListId": 31,
    "contingencyType": "OCO",
...
func (s *apiTradeTestSuite) assertTestQueryOpenOrderListResponse(r1, r2 *QueryOpenOrderListResponse) {
	r := s.r()
	r.Equal(r1.OrderListId, r2.OrderListId, "orderListId")
	r.Equal(r1.ContingencyType, r2.ContingencyType, "contingencyType")
	r.Equal(r1.ListStatusType, r2.ListStatusType, "listStatusType")
...
func (s *apiTradeTestSuite) TestNewCreateSOROrder() {
	msg := []byte(`{
  "symbol": "BTCUSDT",
  "orderId": 2,
  "orderListId": -1,
...
func (s *apiTradeTestSuite) assertTestCreateSOROrderResponse(r1, r2 *CreateSOROrderResponse) {
	r := s.r()
	r.Equal(r1.Symbol, r2.Symbol, "Symbol")
	r.Equal(r1.OrderId, r2.OrderId, "OrderId")
	r.Equal(r1.OrderListId, r2.OrderListId, "OrderListId")
...
func (s *apiTradeTestSuite) TestNewCreateTestSOROrder() {
	msg := []byte(`{
  "standardCommissionForOrder": {
    "maker": "0.00000112",
    "taker": "0.00000114"
