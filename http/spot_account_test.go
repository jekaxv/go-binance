...
func (s *apiAccountTestSuite) assertTestAccountInfo(r1, r2 *AccountInfoResponse) {
	r := s.r()
...
func (s *apiAccountTestSuite) TestAccountTradeList() {
	msg := []byte(`[
  {
    "symbol": "BNBBTC",
    "id": 28457,
...
func (s *apiAccountTestSuite) assertTestAccountOrderHistoryResult(r1, r2 *AccountTradeResponse) {
	r := s.r()
...
func (s *apiAccountTestSuite) assertTestUnfilledOrder(r1, r2 []*QueryUnfilledOrderResponse) {
	for i := range r1 {
		s.assertTestUnfilledOrderResult(r1[i], r2[i])
	}
}

func (s *apiAccountTestSuite) assertTestUnfilledOrderResult(r1, r2 *QueryUnfilledOrderResponse) {
	r := s.r()
...
func (s *apiAccountTestSuite) TestQueryPreventedMatches() {
	msg := []byte(`[
  {
    "symbol": "BTCUSDT",
    "preventedMatchId": 1,
...
func (s *apiAccountTestSuite) assertTestQueryPreventedMatches(r1, r2 *QueryPreventedMatchesResponse) {
	r := s.r()
	r.Equal(r1.Symbol, r2.Symbol, "symbol")
...
func (s *apiAccountTestSuite) TestQueryAllocations() {
	msg := []byte(`[
  {
    "symbol": "BTCUSDT",
    "preventedMatchId": 1,
...
func (s *apiAccountTestSuite) assertTestQueryAllocations(r1, r2 *QueryAllocationsResponse) {
	r := s.r()
	r.Equal(r1.Symbol, r2.Symbol, "symbol")
...
func (s *apiAccountTestSuite) TestQueryCommissionRates() {
	msg := []byte(`{
  "symbol": "BTCUSDT",
  "standardCommission": {
    "maker": "0.00000000",
...
func (s *apiAccountTestSuite) assertTestAccountCommission(r1, r2 *QueryCommissionResponse) {
	r := s.r()
	r.Equal(r1.Symbol, r2.Symbol, "symbol")
...
func (s *apiAccountTestSuite) TestUserDataStreamEndpoints() {
...
func (s *apiAccountTestSuite) TestCloseUserDataStream() {
	msg := []byte(`{}`)
	server := s.setup(msg)
	defer server.Close()
...
func (s *apiAccountTestSuite) TestPingUserDataStream() {
	msg := []byte(`{}`)
	server := s.setup(msg)
	defer server.Close()
