...
type ExchangeInfoResponse struct {
	...
	ServerTime      uint64                  `json:"serverTime"`
	RateLimits      []*https.RateLimit      `json:"rateLimits"`
	ExchangeFilters []*https.ExchangeFilter `json:"exchangeFilters"`
...
func (s *ContractKline) ContractType(contractType types.ContractType) *ContractKline {
	s.contractType = contractType
	return s
}

func (s *ContractKline) Interval(interval types.IntervalEnum) *ContractKline {
	s.interval = interval
	return s
}
...
func (s *IndexKline) Interval(interval types.IntervalEnum) *IndexKline {
	s.interval = interval
	return s
}
...
func (s *MarkKline) Interval(interval types.IntervalEnum) *MarkKline {
	s.interval = interval
	return s
}
...
func (s *PremiumKline) Interval(interval types.IntervalEnum) *PremiumKline {
	s.interval = interval
	return s
}
...
func (s *OpenInterestHist) Period(period types.IntervalEnum) *OpenInterestHist {
	s.period = period
	return s
}
...
// Period "5m","15m","30m","1h","2h","4h","6h","12h","1d"
func (s *TopTraderPositionsRatio) Period(period types.IntervalEnum) *TopTraderPositionsRatio {
	s.period = period
	return s
}
...
// Period "5m","15m","30m","1h","2h","4h","6h","12h","1d"
func (s *TopTraderAccountsRatio) Period(period types.IntervalEnum) *TopTraderAccountsRatio {
	s.period = period
	return s
}
...
// Period "5m","15m","30m","1h","2h","4h","6h","12h","1d"
func (s *SymbolRatio) Period(period types.IntervalEnum) *SymbolRatio {
	s.period = period
	return s
}
...
// Period "5m","15m","30m","1h","2h","4h","6h","12h","1d"
func (s *TakerVolume) Period(period types.IntervalEnum) *TakerVolume {
	s.period = period
	return s
}
...
func (s *FutureBasis) ContractType(contractType types.ContractType) *FutureBasis {
	s.contractType = contractType
	return s
}

// Period "5m","15m","30m","1h","2h","4h","6h","12h","1d"
func (s *FutureBasis) Period(period types.IntervalEnum) *FutureBasis {
	s.period = period
	return s
}
