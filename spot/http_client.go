...
func (c *Client) NewCancelOpenOrder() *CancelOpenOrder {
	c.C.SetReq("/api/v3/openOrders", http.MethodDelete, core.AuthSigned)
...
func (c *Client) NewQueryAllOrderLists() *QueryAllOrderLists {
	c.C.SetReq("/api/v3/allOrderList", http.MethodGet, core.AuthSigned)
...
func (c *Client) NewQueryOpenOrderList() *QueryOpenOrderList {
	c.C.SetReq("/api/v3/openOrderList", http.MethodGet, core.AuthSigned)
	return &QueryOpenOrderList{c: c}
}

// NewCreateSOROrder Create SOR Order (TRADE)
func (c *Client) NewCreateSOROrder() *CreateSOROrder {
	c.C.SetReq("/api/v3/sor/order", http.MethodPost, core.AuthSigned)
...
func (c *Client) NewQueryUnfilledOrder() *QueryUnfilledOrder {
	c.C.SetReq("/api/v3/rateLimit/order", http.MethodGet, core.AuthSigned)
...
func (c *Client) NewQueryPreventedMatches() *QueryPreventedMatches {
	c.C.SetReq("/api/v3/myPreventedMatches", http.MethodGet, core.AuthSigned)
...
func (c *Client) NewQueryAllocations() *QueryAllocations {
	c.C.SetReq("/api/v3/myAllocations", http.MethodGet, core.AuthSigned)
...
func (c *Client) NewQueryCommission() *QueryCommission {
	c.C.SetReq("/api/v3/account/commission", http.MethodGet, core.AuthSigned)
...
func (c *Client) NewStartUserDataStream() *StartUserDataStream {
	c.C.SetReq("/api/v3/userDataStream", http.MethodPost, core.AuthApiKey)
...
func (c *Client) NewCloseUserDataStream() *CloseUserDataStream {
	c.C.SetReq("/api/v3/userDataStream", http.MethodDelete, core.AuthApiKey)
...
func (c *Client) NewPingUserDataStream() *PingUserDataStream {
	c.C.SetReq("/api/v3/userDataStream", http.MethodPut, core.AuthApiKey)
