...
func (s *baseHttpTestSuite) assertCommissionRate(r1, r2 *Commission) {
	r := s.r()
...
func (s *baseHttpTestSuite) assertBalance(r1, r2 *ApiBalance) {
	r := s.r()
...
func (s *baseHttpTestSuite) assertApiFill(r1, r2 *Fill) {
	r := s.r()
...
func (s *baseHttpTestSuite) assertApiOrder(r1, r2 *Order) {
	r := s.r()
...
func (s *baseHttpTestSuite) assertApiOrderReport(r1, r2 *OrderReport) {
	r := s.r()
	r.Equal(r1.Symbol, r2.Symbol, "symbol")
	r.Equal(r1.OrderId, r2.OrderId, "orderId")
