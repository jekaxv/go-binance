...
func (s *apiTradeTestSuite) TestCreateOrder() {
  ...
  "rateLimits": [
	...
	r := s.r()
	r.Empty(err)
	var testResp *WsCreateOrderResponse
	r.Empty(json.Unmarshal(msg, &testResp))
	s.assertTestCreateOrder(resp, testResp)
}

func (s *apiTradeTestSuite) assertTestCreateOrder(r1, r2 *WsCreateOrderResponse) {
...
func (s *apiTradeTestSuite) TestCreateTestOrder() {
  ...
  "rateLimits": [
	...
	r := s.r()
	r.Empty(err)
	var testResp *WsCreateOrderTestResponse
	r.Empty(json.Unmarshal(msg, &testResp))
	s.assertTestCreateTestOrder(resp, testResp)
}
func (s *apiTradeTestSuite) assertTestCreateTestOrder(r1, r2 *WsCreateOrderTestResponse) {
	s.assertWsResponse(r1.ApiResponse, r2.ApiResponse)
	r := s.r()
...
func (s *apiTradeTestSuite) TestQueryOrder() {
  ...
  "rateLimits": [
	...
	r := s.r()
	r.Empty(err)
	var testResp *WsQueryOrderResponse
	r.Empty(json.Unmarshal(msg, &testResp))
	s.assertTestQueryOrder(resp, testResp)
}

func (s *apiTradeTestSuite) assertTestQueryOrder(r1, r2 *WsQueryOrderResponse) {
	s.assertWsResponse(r1.ApiResponse, r2.ApiResponse)
	r := s.r()
	r.Equal(r1.Result.Symbol, r2.Result.Symbol, "Symbol")
	r.Equal(r1.Result.OrderId, r2.Result.OrderId, "OrderId")
...
func (s *apiTradeTestSuite) TestCancelOrder() {
  ...
  "rateLimits": [
	...
	r := s.r()
	r.Empty(err)
	var testResp *WsCancelOrderResponse
	r.Empty(json.Unmarshal(msg, &testResp))
	s.assertTestCancelOrder(resp, testResp)
}

func (s *apiTradeTestSuite) assertTestCancelOrder(r1, r2 *WsCancelOrderResponse) {
	s.assertWsResponse(r1.ApiResponse, r2.ApiResponse)
	r := s.r()
	r.Equal(r1.Result.Symbol, r2.Result.Symbol, "Symbol")
...
func (s *apiTradeTestSuite) TestCancelReplaceOrder() {
  ...
  "rateLimits": [
	...
	r := s.r()
	r.Empty(err)
	var testResp *WsCancelReplaceOrderResponse
	r.Empty(json.Unmarshal(msg, &testResp))
	s.assertTestCancelReplaceOrder(resp, testResp)
}
func (s *apiTradeTestSuite) assertTestCancelReplaceOrder(r1, r2 *WsCancelReplaceOrderResponse) {
	r := s.r()
...
func (s *apiTradeTestSuite) TestOpenOrdersStatus() {
  ...
  "rateLimits": [
	...
	r := s.r()
	r.Empty(err)
	var testResp *WsOpenOrdersStatusResponse
	r.Empty(json.Unmarshal(msg, &testResp))
	s.assertTestOpenOrdersStatus(resp, testResp)
}

func (s *apiTradeTestSuite) assertTestOpenOrdersStatus(r1, r2 *WsOpenOrdersStatusResponse) {
	s.assertWsResponse(r1.ApiResponse, r2.ApiResponse)
...
func (s *apiTradeTestSuite) TestCancelOpenOrder() {
  ...
  "rateLimits": [
	...
	r := s.r()
	r.Empty(err)
	var testResp *WsCancelOpenOrderResponse
	r.Empty(json.Unmarshal(msg, &testResp))
	s.assertTestCancelOpenOrder(resp, testResp)
}

func (s *apiTradeTestSuite) assertTestCancelOpenOrder(r1, r2 *WsCancelOpenOrderResponse) {
	s.assertWsResponse(r1.ApiResponse, r2.ApiResponse)
	for i := range r1.Result {
...
func (s *apiTradeTestSuite) TestCreateOCOOrder() {
  ...
  [
	...
	resp, err := s.client.NewCreateOCOOrder().Symbol("LTCBNB").
		Side(core.OrderSideBUY).
		Quantity("1").
		AboveType(core.OrderTypeSTOP_LOSS_LIMIT).
		AbovePrice("1.5").
		AboveStopPrice("1.50000001").
		AboveTimeInForce(core.TimeInForceGTC).
		BelowType(core.OrderTypeLIMIT_MAKER).
...
func (s *apiTradeTestSuite) TestCreateOTOOrder() {
  ...
  "rateLimits": [
	...
	resp, err := s.client.NewCreateOTOOrder().Symbol("LTCBNB").
		PendingSide(core.OrderSideBUY).
		PendingQuantity("1").
		PendingType(core.OrderTypeMARKET).
		WorkingPrice("1").
		WorkingQuantity("1").
		WorkingSide(core.OrderSideSELL).
		WorkingTimeInForce(core.TimeInForceGTC).
		WorkingType(core.OrderTypeLIMIT).
		Do(context.Background())
	r := s.r()
	r.Empty(err)
	var testResp *OrderResponse
...
func (s *apiTradeTestSuite) TestCreateOTOCOOrder() {
  ...
  "rateLimits": [
	...
	resp, err := s.client.NewCreateOTOCOOrder().Symbol("LTCBNB").
		PendingSide(core.OrderSideBUY).
		PendingQuantity("5").
		PendingSide(core.OrderSideSELL).
		PendingBelowPrice("5").
		PendingBelowType(core.OrderTypeLIMIT_MAKER).
		PendingAboveStopPrice("0.5").
		PendingAboveType(core.OrderTypeSTOP_LOSS).
		WorkingPrice("1.6").
		WorkingSide(core.OrderSideBUY).
		WorkingTimeInForce(core.TimeInForceGTC).
		WorkingType(core.OrderTypeLIMIT).
		Do(context.Background())
	r := s.r()
...
func (s *apiTradeTestSuite) TestQueryOrderList() {
  ...
  "rateLimits": [
	...
	r := s.r()
	r.Empty(err)
	var testResp *WsOrderListResponse
	r.Empty(json.Unmarshal(msg, &testResp))
	s.assertTestOrderList(resp, testResp)
}
func (s *apiTradeTestSuite) assertTestOrderList(r1, r2 *WsOrderListResponse) {
	s.assertWsResponse(r1.ApiResponse, r2.ApiResponse)
...
func (s *apiTradeTestSuite) TestQueryOpenOrder() {
  ...
  "rateLimits": [
	...
	r := s.r()
	r.Empty(err)
	var testResp *WsQueryOpenOrderResponse
	r.Empty(json.Unmarshal(msg, &testResp))
	s.assertTestQueryOpenOrder(resp, testResp)
}
func (s *apiTradeTestSuite) assertTestQueryOpenOrder(r1, r2 *WsQueryOpenOrderResponse) {
	s.assertWsResponse(r1.ApiResponse, r2.ApiResponse)
	for i := range r1.Result {
...
func (s *apiTradeTestSuite) TestCreateSOROrder() {
  ...
  "rateLimits": [
	...
	r := s.r()
	r.Empty(err)
	var testResp *WsCreateSOROrderResponse
	r.Empty(json.Unmarshal(msg, &testResp))
	s.assertTestCreateSOROrder(resp, testResp)
}
func (s *apiTradeTestSuite) assertTestCreateSOROrder(r1, r2 *WsCreateSOROrderResponse) {
	s.assertWsResponse(r1.ApiResponse, r2.ApiResponse)
	for i := range r1.Result {
...
func (s *apiTradeTestSuite) TestCreateTestSOROrder() {
  ...
  "rateLimits": [
	...
	r := s.r()
	r.Empty(err)
	var testResp *WsCreateTestSOROrderResponse
	r.Empty(json.Unmarshal(msg, &testResp))
	s.assertTestCreateTestSOROrder(resp, testResp)
}
func (s *apiTradeTestSuite) assertTestCreateTestSOROrder(r1, r2 *WsCreateTestSOROrderResponse) {
	s.assertWsResponse(r1.ApiResponse, r2.ApiResponse)
	r := s.r()
	r.Equal(r1.Result.StandardCommissionForOrder.Maker, r2.Result.StandardCommissionForOrder.Maker, "StandardCommissionForOrder.maker")
	r.Equal(r1.Result.StandardCommissionForOrder.Taker, r2.Result.StandardCommissionForOrder.Taker, "StandardCommissionForOrder.taker")
