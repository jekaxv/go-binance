...
type wsApiAccountTestSuite struct {
	baseWsTestSuite
}

func TestWebsocketApiAccount(t *testing.T) {
	suite.Run(t, new(wsApiAccountTestSuite))
}

func (s *wsApiAccountTestSuite) TestAccountInformation() {
	msg := []byte(`{
...
func (s *wsApiAccountTestSuite) assertTestAccountInfo(r1, r2 *AccountInformationResponse) {
	s.assertWsResponse(r1.ApiResponse, r2.ApiResponse)
	s.assertTestAccountInfoResult(r1.Result, r2.Result)
}

func (s *wsApiAccountTestSuite) assertTestAccountInfoResult(r1, r2 *AccountInformationResult) {
	r := s.r()
...
func (s *wsApiAccountTestSuite) TestUnfilledOrder() {
...
func (s *wsApiAccountTestSuite) assertTestUnfilledOrder(r1, r2 *UnfilledOrderResponse) {
	s.assertWsResponse(r1.ApiResponse, r2.ApiResponse)
...
func (s *wsApiAccountTestSuite) assertTestUnfilledOrderResult(r1, r2 *UnfilledOrderResult) {
	r := s.r()
...
func (s *wsApiAccountTestSuite) TestAccountOrderHistory() {
	msg := []byte(`{
...
func (s *wsApiAccountTestSuite) assertTestAccountOrderHistory(r1, r2 *AccountOrderHistoryResponse) {
	s.assertWsResponse(r1.ApiResponse, r2.ApiResponse)
	for i := range r1.Result {
		s.assertTestAccountOrderHistoryResult(r1.Result[i], r2.Result[i])
	}
}
func (s *wsApiAccountTestSuite) assertTestAccountOrderHistoryResult(r1, r2 *AccountOrderHistoryResult) {
	r := s.r()
...
func (s *wsApiAccountTestSuite) TestAllOrderList() {
	msg := []byte(`{
...
func (s *wsApiAccountTestSuite) assertTestAllOrderList(r1, r2 *AllOrderListResponse) {
	s.assertWsResponse(r1.ApiResponse, r2.ApiResponse)
	for i := range r1.Result {
...
func (s *wsApiAccountTestSuite) assertTestAllOrderListResult(r1, r2 *AllOrderListResult) {
	r := s.r()
	r.Equal(r1.OrderListId, r2.OrderListId, "orderListId")
...
func (s *wsApiAccountTestSuite) TestAccountTradeHistory() {
	msg := []byte(`{
...
func (s *wsApiAccountTestSuite) assertTestAccountTradeHistory(r1, r2 *AccountTradeHistoryResponse) {
	s.assertWsResponse(r1.ApiResponse, r2.ApiResponse)
	for i := range r1.Result {
...
func (s *wsApiAccountTestSuite) assertTestAccountTradeHistoryResult(r1, r2 *AccountTradeHistoryResult) {
	r := s.r()
	r.Equal(r1.Symbol, r2.Symbol, "symbol")
...
func (s *wsApiAccountTestSuite) TestAccountPreventedMatches() {
	msg := []byte(`{
...
func (s *wsApiAccountTestSuite) assertTestAccountPreventedMatches(r1, r2 *AccountPreventedMatchesResponse) {
	s.assertWsResponse(r1.ApiResponse, r2.ApiResponse)
	for i := range r1.Result {
...
func (s *wsApiAccountTestSuite) assertTestAccountPreventedMatchesResult(r1, r2 *AccountPreventedMatchesResult) {
	r := s.r()
	r.Equal(r1.Symbol, r2.Symbol, "symbol")
	r.Equal(r1.PreventedMatchId, r2.PreventedMatchId, "preventedMatchId")
...
func (s *wsApiAccountTestSuite) TestAccountAllocations() {
	msg := []byte(`{
  "id": "g4ce6a53-a39d-4f71-823b-4ab5r391d6y8",
  "status": 200,
  "result": [
...
func (s *wsApiAccountTestSuite) assertTestAccountAllocations(r1, r2 *AccountAllocationsResponse) {
	s.assertWsResponse(r1.ApiResponse, r2.ApiResponse)
	for i := range r1.Result {
...
func (s *wsApiAccountTestSuite) assertTestAccountAllocationsResult(r1, r2 *AccountAllocationsResult) {
	r := s.r()
	r.Equal(r1.Symbol, r2.Symbol, "symbol")
...
func (s *wsApiAccountTestSuite) TestAccountCommission() {
	msg := []byte(`{
...
func (s *wsApiAccountTestSuite) assertTestAccountCommission(r1, r2 *AccountCommissionResponse) {
	s.assertWsResponse(r1.ApiResponse, r2.ApiResponse)
	r := s.r()
