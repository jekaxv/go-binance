...
func (s *baseWsTestSuite) assertWsApiSymbol(r1, r2 *ApiSymbol) {
	r := s.r()
...
func (s *baseWsTestSuite) assertWsApiSor(r1, r2 *ApiSort) {
	r := s.r()
	r.Equal(r1.BaseAsset, r2.BaseAsset, "baseAsset")
...
func (s *baseWsTestSuite) assertWsApiOrder(r1, r2 *ApiOrder) {
	r := s.r()
	r.Equal(r1.Symbol, r2.Symbol, "symbol")
...
func (s *baseWsTestSuite) assertWsApiFilter(r1, r2 *ApiFilter) {
	r := s.r()
...
func (s *baseWsTestSuite) assertWsApiFill(r1, r2 *ApiFill) {
	r := s.r()
...
func (s *baseWsTestSuite) assertWsApiOrderReport(r1, r2 *ApiOrderReport) {
	r := s.r()
	r.Equal(r1.Symbol, r2.Symbol, "symbol")
	r.Equal(r1.OrderId, r2.OrderId, "orderId")
...
func (s *baseWsTestSuite) assertWsCommissionRate(r1, r2 *ApiCommissionRate) {
	r := s.r()
...
func (s *baseWsTestSuite) assertWsBalance(r1, r2 *ApiBalance) {
	r := s.r()
