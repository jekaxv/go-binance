...
func (s *marketTestSuite) TestNewTrades() {
	msg := []byte(`[
  {
    "id": 28457,
    "price": "4.00000100",
...
func (s *marketTestSuite) assertTestTradesResponse(r1, r2 *TradesResponse) {
	r := s.r()
...
func (s *marketTestSuite) TestNewHistoricalTrades() {
	msg := []byte(`[
  {
    "id": 28457,
    "price": "4.00000100",
...
func (s *marketTestSuite) TestNewAggregateTrades() {
	msg := []byte(`[
  {
    "a": 26129,
    "p": "0.01633102",
...
func (s *marketTestSuite) assertTestAggregateTradesResponse(r1, r2 *AggTradesResponse) {
	r := s.r()
...
func (s *marketTestSuite) TestNewKlineData() {
	msg := []byte(`[
    [
      1737556140000,
      "104552.00000000",
...
func (s *marketTestSuite) assertTestKlineDataResponse(r1, r2 *KlineResult) {
	r := s.r()
...
func (s *marketTestSuite) TestNewUIKlines() {
	msg := []byte(`[
    [
      1737556140000,
      "104552.00000000",
	...
	server := s.setup(msg)
	defer server.Close()
	resp, err := s.client.NewUIKlines().Symbol("BTCUSDT").Interval(core.Interval1m).Do(context.Background())
	r := s.r()
	r.Empty(err)
	testResp := []*KlineResult{{
		OpenTime:                 1737556140000,
...
func (s *marketTestSuite) TestNewAveragePrice() {
	msg := []byte(`{
  "mins": 5,
  "price": "9.35751834",
...
func (s *marketTestSuite) assertTestAveragePriceResponse(r1, r2 *AveragePriceResponse) {
	r := s.r()
	r.Equal(r1.CloseTime, r2.CloseTime, "CloseTime")
...
func (s *marketTestSuite) TestNewTickerPrice24h() {
	msg := []byte(`[{
  "symbol": "BNBBTC",
...
func (s *marketTestSuite) assertTestTickerPrice24hResponse(r1, r2 *TickerPrice24hResponse) {
	r := s.r()
...
func (s *marketTestSuite) TestNewTradingDayTicker() {
	msg := []byte(`[
  {
    "symbol": "BTCUSDT",
...
func (s *marketTestSuite) assertTestTickerResponse(r1, r2 *TickerResponse) {
	r := s.r()
	r.Equal(r1.Symbol, r2.Symbol, "Symbol")
	r.Equal(r1.PriceChange, r2.PriceChange, "PriceChange")
	r.Equal(r1.PriceChangePercent, r2.PriceChangePercent, "PriceChangePercent")
...
func (s *marketTestSuite) TestNewPriceTicker() {
	msg := []byte(`[
  {
    "symbol": "LTCBTC",
    "price": "4.00000200"
...
func (s *marketTestSuite) assertTestPriceTickerResponse(r1, r2 *PriceTickerResponse) {
	r := s.r()
	r.Equal(r1.Symbol, r2.Symbol, "Symbol")
	r.Equal(r1.Price, r2.Price, "Price")
}

func (s *marketTestSuite) TestNewOrderBookTicker() {
	msg := []byte(`[
  {
    "symbol": "LTCBTC",
    "bidPrice": "4.00000000",
...
func (s *marketTestSuite) assertTestOrderBookTickerResponse(r1, r2 *OrderBookTickerResponse) {
	r := s.r()
	r.Equal(r1.Symbol, r2.Symbol, "Symbol")
	r.Equal(r1.BidPrice, r2.BidPrice, "BidPrice")
	r.Equal(r1.BidQty, r2.BidQty, "BidQty")
...
func (s *marketTestSuite) TestNewTicker() {
	msg := []byte(`[
  {
    "symbol": "BTCUSDT",
