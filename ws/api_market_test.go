...
func (s *apiMarketTestSuite) assertTestMarketDepth(r1, r2 *DepthResponse) {
...
func (s *apiMarketTestSuite) TestMarketTradesRecent() {
  ...
  "rateLimits": [
	...
	r := s.r()
	r.Empty(err)
	var testResp *TradesRecentResponse
	r.Empty(json.Unmarshal(msg, &testResp))
	s.assertTestMarketTradesRecent(resp, testResp)
}

func (s *apiMarketTestSuite) assertTestMarketTradesRecent(r1, r2 *TradesRecentResponse) {
	s.assertWsResponse(r1.ApiResponse, r2.ApiResponse)
...
func (s *apiMarketTestSuite) TestMarketTradesHistorical() {
  ...
  "rateLimits": [
	...
	r := s.r()
	r.Empty(err)
	var testResp *TradesHistoricalResponse
	r.Empty(json.Unmarshal(msg, &testResp))
	s.assertTestMarketTradesHistorical(resp, testResp)
}
func (s *apiMarketTestSuite) assertTestMarketTradesHistorical(r1, r2 *TradesHistoricalResponse) {
	s.assertWsResponse(r1.ApiResponse, r2.ApiResponse)
	for i := range r1.Result {
		s.assertTestMarketTradesResult(r1.Result[i], r2.Result[i])
	}
...
func (s *apiMarketTestSuite) TestMarketTradesAggregate() {
  ...
  "rateLimits": [
	...
	r := s.r()
	r.Empty(err)
	var testResp *TradesAggregateResponse
	r.Empty(json.Unmarshal(msg, &testResp))
	s.assertTestMarketTradesAggregate(resp, testResp)
}

func (s *apiMarketTestSuite) assertTestMarketTradesAggregate(r1, r2 *TradesAggregateResponse) {
	s.assertWsResponse(r1.ApiResponse, r2.ApiResponse)
	for i := range r1.Result {
...
func (s *apiMarketTestSuite) TestMarketKline() {
  ...
  "rateLimits": [
	...
	server := s.setup(msg)
	defer server.Close()
	resp, err := s.client.NewKline().Symbol("BTCUSDT").Interval(types.Interval1m).Limit(2).Do(context.Background())
	r := s.r()
	r.Empty(err)
	testResp := KlineResponse{
...
func (s *apiMarketTestSuite) assertTestMarketKline(r1, r2 *KlineResponse) {
	s.assertWsResponse(r1.ApiResponse, r2.ApiResponse)
	for i := range r1.Result {
...
func (s *apiMarketTestSuite) TestMarketUIKline() {
  ...
  "rateLimits": [
	...
	server := s.setup(msg)
	defer server.Close()
	resp, err := s.client.NewUiKlines().Symbol("BTCUSDT").Interval(types.Interval1m).Limit(2).Do(context.Background())
	r := s.r()
	r.Empty(err)
	testResp := KlineResponse{
		ApiResponse: ApiResponse{
...
func (s *apiMarketTestSuite) assertTestMarketAveragePrice(r1, r2 *AveragePriceResponse) {
	s.assertWsResponse(r1.ApiResponse, r2.ApiResponse)
	r := s.r()
...
func (s *apiMarketTestSuite) TestMarketTicker24h() {
  ...
  "rateLimits": [
	...
	r := s.r()
	r.Empty(err)
	var testResp *Ticker24hResponse
	r.Empty(json.Unmarshal(msg, &testResp))
	s.assertTestMarketTicker24h(resp, testResp)
}

func (s *apiMarketTestSuite) assertTestMarketTicker24h(r1, r2 *Ticker24hResponse) {
	s.assertWsResponse(r1.ApiResponse, r2.ApiResponse)
	for i := range r1.Result {
...
func (s *apiMarketTestSuite) TestMarketTickerTradingDay() {
  ...
  "rateLimits": [
	...
	r := s.r()
	r.Empty(err)
	var testResp *TickerTradingDayResponse
	r.Empty(json.Unmarshal(msg, &testResp))
	s.assertTestMarketTickerTradingDay(resp, testResp)
}

func (s *apiMarketTestSuite) assertTestMarketTickerTradingDay(r1, r2 *TickerTradingDayResponse) {
	s.assertWsResponse(r1.ApiResponse, r2.ApiResponse)
	for i := range r1.Result {
...
func (s *apiMarketTestSuite) assertTestMarketTickerPrice(r1, r2 *TickerPriceResponse) {
	s.assertWsResponse(r1.ApiResponse, r2.ApiResponse)
	for i := range r1.Result {
...
func (s *apiMarketTestSuite) assertTestMarketTickerBook(r1, r2 *TickerBookResponse) {
	s.assertWsResponse(r1.ApiResponse, r2.ApiResponse)
	for i := range r1.Result {
