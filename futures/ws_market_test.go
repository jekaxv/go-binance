...
func (s *marketTestSuite) assertTestDepthResponse(r1, r2 *WsDepthResponse) {
...
func (s *marketTestSuite) assertTestTickerPriceResponse(r1, r2 *WsTickerPriceResponse) {
	r := s.r()
	s.assertWsResponse(r1.ApiResponse, r2.ApiResponse)
...
func (s *marketTestSuite) assertTestTickerBookResponse(r1, r2 *WsTickerBookResponse) {
	r := s.r()
	s.assertWsResponse(r1.ApiResponse, r2.ApiResponse)
	for i := range r1.Result {
		r.Equal(r1.Result[i].Symbol, r2.Result[i].Symbol, "Symbol")
