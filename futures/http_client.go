...
func (c *Client) NewTopTraderPositionsRatio() *TopTraderPositionsRatio {
	c.SetReq("/futures/data/topLongShortPositionRatio", http.MethodGet)
...
func (c *Client) NewConstituentsPrice() *ConstituentsPrice {
	c.SetReq("/fapi/v1/constituents", http.MethodGet)
...
func (c *Client) NewModifyMultipleOrder() *ModifyMultipleOrder {
	c.SetReq("/fapi/v1/batchOrders", http.MethodPut, core.AuthSigned)
...
func (c *Client) NewOrderAmendment() *OrderAmendment {
	c.SetReq("/fapi/v1/orderAmendment", http.MethodGet, core.AuthSigned)
	return &OrderAmendment{c: c}
}

// NewCancelOrder Cancel Order (TRADE)
func (c *Client) NewCancelOrder() *CancelOrder {
	c.SetReq("/fapi/v1/order", http.MethodDelete, core.AuthSigned)
...
func (c *Client) NewCancelMultipleOrder() *CancelMultipleOrder {
	c.SetReq("/fapi/v1/batchOrders", http.MethodDelete, core.AuthSigned)
...
func (c *Client) NewCancelOpenOrder() *CancelOpenOrder {
	c.SetReq("/fapi/v1/allOpenOrders", http.MethodDelete, core.AuthSigned)
...
func (c *Client) NewChangePositionSide() *ChangePositionSide {
	c.SetReq("/fapi/v1/positionSide/dual", http.MethodPost, core.AuthSigned)
...
func (c *Client) NewChangeLeverage() *ChangeLeverage {
	c.SetReq("/fapi/v1/leverage", http.MethodPost, core.AuthSigned)
...
func (c *Client) NewChangeMultiAssetsMargin() *ChangeMultiAssetsMargin {
	c.SetReq("/fapi/v1/multiAssetsMargin", http.MethodPost, core.AuthSigned)
...
func (c *Client) NewChangePositionMargin() *ChangePositionMargin {
	c.SetReq("/fapi/v1/positionMargin", http.MethodPost, core.AuthSigned)
...
func (c *Client) NewPositionMarginHistory() *PositionMarginHistory {
	c.SetReq("/fapi/v1/positionMargin/history", http.MethodGet, core.AuthSigned)
	return &PositionMarginHistory{c: c}
}

// NewCreateTestOrder Test Order(TRADE)
func (c *Client) NewCreateTestOrder() *CreateTestOrder {
	c.SetReq("/fapi/v1/order/test", http.MethodPost, core.AuthSigned)
...
func (c *Client) NewLeverageBracket() *LeverageBracket {
	c.SetReq("/fapi/v1/leverageBracket", http.MethodGet, core.AuthSigned)
...
func (c *Client) NewMultiAssetsMargin() *MultiAssetsMargin {
	c.SetReq("/fapi/v1/multiAssetsMargin", http.MethodGet, core.AuthSigned)
...
func (c *Client) NewGetPositionSide() *GetPositionSide {
	c.SetReq("/fapi/v1/positionSide/dual", http.MethodGet, core.AuthSigned)
	return &GetPositionSide{c: c}
}

// NewQueryIncome Get Income History (USER_DATA)
func (c *Client) NewQueryIncome() *QueryIncome {
	c.SetReq("/fapi/v1/income", http.MethodGet, core.AuthSigned)
...
func (c *Client) NewTradingStatus() *TradingStatus {
	c.SetReq("/fapi/v1/apiTradingStatus", http.MethodGet, core.AuthSigned)
...
func (c *Client) NewTransactionHistory() *TransactionHistory {
	c.SetReq("/fapi/v1/income/asyn", http.MethodGet, core.AuthSigned)
...
func (c *Client) NewTransactionHistoryLink() *TransactionHistoryLink {
	c.SetReq("/fapi/v1/income/asyn/id", http.MethodGet, core.AuthSigned)
...
func (c *Client) NewOrderHistory() *OrderHistory {
	c.SetReq("/fapi/v1/order/asyn", http.MethodGet, core.AuthSigned)
...
func (c *Client) NewOrderHistoryLink() *OrderHistoryLink {
	c.SetReq("/fapi/v1/order/asyn/id", http.MethodGet, core.AuthSigned)
...
func (c *Client) NewTradeHistory() *TradeHistory {
	c.SetReq("/fapi/v1/trade/asyn", http.MethodGet, core.AuthSigned)
...
func (c *Client) NewTradeHistoryLink() *TradeHistoryLink {
	c.SetReq("/fapi/v1/trade/asyn/id", http.MethodGet, core.AuthSigned)
...
func (c *Client) NewKeepaliveListenKey() *KeepaliveListenKey {
	c.SetReq("/fapi/v1/listenKey", http.MethodPut, core.AuthApiKey)
...
func (c *Client) NewCloseListenKey() *CloseListenKey {
	c.SetReq("/fapi/v1/listenKey", http.MethodDelete, core.AuthApiKey)
